...
use miraland_gateway::error::GatewayError;
use miraland_gateway::instruction::{GatewayInstruction, NetworkFeature};
...
use {
    ...
    miraland_gateway::{borsh::get_instance_packed_len, state::GatewayToken},
    solana_program::{
